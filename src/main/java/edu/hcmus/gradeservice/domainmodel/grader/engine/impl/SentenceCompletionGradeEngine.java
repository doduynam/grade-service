...
public class SentenceCompletionGradeEngine extends BaseGradeEngine {
    ...
    public Integer executeComparison(Question questionHasCorrectAnswer, IQuestion questionHasUserSubmission) {
        ...
        SentenceCompletionAnswer userAnswer = ((SentenceCompletionQuestion) questionHasUserSubmission).getAnswer();
