...
public class MultipleChoiceGradeEngine extends BaseGradeEngine {
    ...
    public Integer executeComparison(Question questionHasCorrectAnswer, IQuestion questionHasUserSubmission) {
        ...
        MultipleChoiceAnswer userAnswer = ((MultipleChoiceQuestion) questionHasUserSubmission).getAnswer();
