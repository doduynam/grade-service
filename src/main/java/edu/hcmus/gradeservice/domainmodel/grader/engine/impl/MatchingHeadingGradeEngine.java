...
import edu.hcmus.gradeservice.domainmodel.question.impl.MatchingHeadingQuestion;
...
public class MatchingHeadingGradeEngine extends BaseGradeEngine {
    ...
    public Integer executeComparison(Question questionHasCorrectAnswer, IQuestion questionHasUserSubmission) {
        ...
        MatchingHeadingAnswer userAnswer = ((MatchingHeadingQuestion) questionHasUserSubmission).getAnswer();
